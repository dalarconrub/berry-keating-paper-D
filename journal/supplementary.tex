...
extrapolation at $L = 1000$, $3000$, $10{,}000$, and $30{,}000$) and $c_E = +2.50$
...
yields $c_{R_3} = -1.25$ (ab initio) and $c_E = +2.50$ (by difference).}
\end{figure}
...
The conditional proof (Theorem~\ref{thm:main}: (H1)$\Rightarrow$RH) is detailed
in Sections~4 and S2 of this paper. The unconditional proof---establishing (H1) itself
