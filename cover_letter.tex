...
an ab initio verification of the correction coefficient from the Conrey-Snaith
triple correlation formula, the unconditional proof via Rudnick-Sarnak
correlations and linear programming, and the full dataset and analysis.
